...
add_filter( 'plugin_action_links_advanced-htaccess-optimizer-editor/advancedhtaccess-optimizer.php', 'advancedhtaccessoptimizer_settings_link' );

function advancedhtaccessoptimizer_settings_link( $links ) {
...
add_action('admin_init', 'advancedhtaccessoptimizer_create_wp_content_htaccess');
...
add_action('admin_init', 'advancedhtaccessoptimizer_create_wp_includes_htaccess');
...
add_action('admin_init', 'advancedhtaccessoptimizer_create_wp_uploads_htaccess');
